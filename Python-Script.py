...
if str(platform.system()) == 'Linux':
    os.system('figlet FG DDoS Attack')
else:
    os.system('pyfiglet itSmefg  DDoS Attack')

print(Back.GREEN + Fore.GREEN +'[+] DDoS tool by' + Fore.RED + ' FG                               ') 
print(Back.GREEN + Fore.BLACK + '[+] DDoS Tool BETA VERSION 0.4                                             ')
print(Back.BLACK +Fore.GREEN + '[+] FG-DDoS                          ')
print(Fore.YELLOW + '[+] ITS ME FARHAN                            ')
print(Fore.GREEN + '[+] Starting 1024 Threads as Default change below as Required           ')
print(Fore.BLUE + 'edited by: ' + Fore.GREEN + ' (FG)')
